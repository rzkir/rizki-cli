...
// Recent Logs (dummy data, tanpa koneksi database)
$recentLogs = [
    [
        'fullname'    => 'Admin Demo',
        'action'      => 'login_success',
        'description' => 'Berhasil login sebagai admin demo',
        'created_at'  => date('Y-m-d H:i:s', strtotime('-10 minutes')),
    ],
    [
        'fullname'    => 'Admin Demo',
        'action'      => 'home_update',
        'description' => 'Mengubah konten section hero pada halaman Home',
        'created_at'  => date('Y-m-d H:i:s', strtotime('-30 minutes')),
    ],
    [
        'fullname'    => 'Content Writer Demo',
        'action'      => 'service_create',
        'description' => 'Menambahkan layanan baru "Ship Chartering"',
        'created_at'  => date('Y-m-d H:i:s', strtotime('-1 hour')),
    ],
    [
        'fullname'    => 'Content Writer Demo',
        'action'      => 'mission_update',
        'description' => 'Mengupdate teks misi perusahaan',
        'created_at'  => date('Y-m-d H:i:s', strtotime('-2 hours')),
    ],
];

// Map action ke modul (dummy data untuk demo)
$actionToModule = [
    'management_system' => 'Dummy Management System',
    'mission' => 'Dummy Mission',
    'contact' => 'Dummy Contact',
    'partnership' => 'Dummy Partnership',
    'ship_type' => 'Dummy Ship Types',
    'company_kpis' => 'Dummy Company KPIs',
    'sky_sai_brain' => 'Dummy SKY SAI Brain',
    'service' => 'Dummy Services',
    'tagline' => 'Dummy Tagline',
    'home' => 'Dummy Home',
    'login' => 'Dummy Auth',
    'logout' => 'Dummy Auth',
    'register' => 'Dummy Auth',
    'change_password' => 'Dummy Auth',
];
...
{
    $labels = [
        'management_system_create' => 'Buat',
        'management_system_update' => 'Ubah',
        'management_system_delete' => 'Hapus',
        'mission_create' => 'Buat',
        'mission_update' => 'Ubah',
        'mission_delete' => 'Hapus',
        'contact_create' => 'Buat',
        'contact_update' => 'Ubah',
        'contact_delete' => 'Hapus',
        'partnership_create' => 'Buat',
        'partnership_update' => 'Ubah',
        'partnership_delete' => 'Hapus',
        'ship_type_create' => 'Buat',
        'ship_type_update' => 'Ubah',
        'ship_type_delete' => 'Hapus',
        'company_kpis_create' => 'Buat',
        'company_kpis_update' => 'Ubah',
        'company_kpis_delete' => 'Hapus',
        'sky_sai_brain_create' => 'Buat',
        'sky_sai_brain_update' => 'Ubah',
        'sky_sai_brain_delete' => 'Hapus',
        'service_create' => 'Buat',
        'service_update' => 'Ubah',
        'service_delete' => 'Hapus',
        'tagline_create' => 'Buat',
        'tagline_update' => 'Ubah',
        'tagline_delete' => 'Hapus',
        'home_create' => 'Buat',
        'home_update' => 'Ubah',
        'home_delete' => 'Hapus',
        'login_success' => 'Login',
        'login_failed' => 'Login gagal',
        'login_denied' => 'Akses ditolak',
        'login_blocked_ip' => 'IP diblokir',
        'login_error' => 'Error login',
        'logout' => 'Logout',
        'register_success' => 'Daftar',
        'register_failed' => 'Daftar gagal',
        'register_error' => 'Error daftar',
