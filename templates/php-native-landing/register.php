...
<head>
    ...
    <title>Register Admin - Your Company</title>
...
<body class="min-h-screen bg-slate-100 flex items-center justify-center py-8">
    <div class="w-full max-w-md">
        <div class="bg-white shadow-lg rounded-xl p-8">
            ...
            <p class="text-sm text-slate-500 text-center mb-6">Buat akun admin untuk mengelola your company.</p>
        ...
        <p class="mt-6 text-xs text-center text-slate-400">
            &copy; <?php echo date('Y'); ?> <a href="https://rizkiramadhan.web.id">Rizki Ramadhan</a>. All rights reserved.
        </p>
    </div>
